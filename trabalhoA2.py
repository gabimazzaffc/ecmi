...
st.altair_chart(alt.Chart(media_interactions_semana).mark_line().encode(x='Semana', y='Interactions Growth', color='Account', tooltip=['Account', 'Semana', 'Interactions Growth']), use_container_width=True)
